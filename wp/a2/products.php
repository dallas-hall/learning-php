	...
	<main id="singlePage">
		...
		<section id="psychicServices">
			...
			<section id="simplyTarot">
				<h4>Simply Tarot</h4>
				<article id="simplyTarotKitsWithDVD" class="allProducts">
					<h5>Simply Tarot Kit With DVD</h5>
					...
					<p>This set is limited edition and will cost $103.00
						AUD.</p>
			...
			<section id="secretsOfTarot" class="allProducts">
				...
				<article id="secretsOfTarotKits" class="allProducts">
					<h5>Simply Tarot Kit</h5>
					<img src="img/products/psychic/tarot/secrets/secrets_book_and_card.jpg"
						 width="256px"
						 height="170px">
					<p>This Secrets Of Tarot Kit includes:</p>
					<ul>
						<li>Simply Tarot Training Book.</li>
						<li>Simply Tarot Card Set.</li>
					</ul>
